                ...
                <div className="app-container">
                    ...
                    <div className="left-side">
                        <div className="navigation">
                            <div className="nav-link icon" title="Video chat" style={{ backgroundColor: backgroundColorForVideoChat }} onClick={() => {
                                setDisplayVideo(true)
                            }}>
                                <img src={videoChatIcon} alt='videoChat' />
                            </div>
                            <div className="nav-link icon" title="Code editor" style={{ backgroundColor: backgroundColorForCodeEditor }} onClick={() => {
